...
class PostNatalCareMother : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_post_natal_care_mother)
        ...
        supportFragmentManager.setFragmentResultListener(
            ...
            Log.d("MotherPostnatal", "Submit request received")
            submitQuestionnaire()
        }
    }
            ...
            retrofitCallsFhir.submitQuestionnaireResponse(questionnaireResponseString, object :
                ...
                override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                    if (response.isSuccessful) {
                        Toast.makeText(this@PostNatalCareMother, "Successfully submitted!", Toast.LENGTH_SHORT).show()
                        Log.d("ChildAdd", "Successfully submitted the questionnaire response.")
                    } else {
                        Toast.makeText(this@PostNatalCareMother, "Submission failed: ${response.message()}", Toast.LENGTH_SHORT).show()
                        Log.e("Error", "Failed to submit. Response code: ${response.code()}")
                    }
                }

                override fun onFailure(call: Call<ResponseBody>, t: Throwable) {
                    Toast.makeText(this@PostNatalCareMother, "Error occurred while submitting: ${t.message}", Toast.LENGTH_SHORT).show()
