...
class Aefi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_aefi)
        ...
        supportFragmentManager.setFragmentResultListener(
            ...
            Log.d("AEFI", "Submit request received")
            submitQuestionnaire()
        }
    }
            ...
            retrofitCallsFhir.submitQuestionnaireResponse(questionnaireResponseString, object :
                ...
                override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                    if (response.isSuccessful) {
                        Toast.makeText(this@Aefi, "Successfully submitted!", Toast.LENGTH_SHORT).show()
                        Log.d("AEFIAdd", "Successfully submitted the questionnaire response.")
                    } else {
                        Toast.makeText(this@Aefi, "Submission failed: ${response.message()}", Toast.LENGTH_SHORT).show()
                        Log.e("Error", "Failed to submit. Response code: ${response.code()}")
                    }
                }

                override fun onFailure(call: Call<ResponseBody>, t: Throwable) {
                    Toast.makeText(this@Aefi, "Error occurred while submitting: ${t.message}", Toast.LENGTH_SHORT).show()
